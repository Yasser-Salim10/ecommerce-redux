...
const Slider = () => {
  ...
  return (
    <div className="relative pb-4">
        <div >
            {sliderData.map((item)=> {
                return <div key={item.id} className={parseInt(item.id) === sliderIndex 
                    ...
                    <div className="absolute top-44 mx-auto inset-x-1/4">
                        <p className="text-white text-4xl font-inter tracking-normal leading-none">
        ...
        <div className="flex absolute bottom-12 left-[45%]">
            {sliderData.map((dot, index)=> {
                return <div className="mr-4" key={dot.id}>
                    <div className={index ===sliderIndex ? 
