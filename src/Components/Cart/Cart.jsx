                                ...
                                <div className="grid grid-cols-2 py-4">
                                    <div>
                                        ...
                                        <div className="flex flex-col items-start">
                                            <h4 className="text-black text-3xl font-inter font-bold tracking-normal leading-none pt-2">
                                                {item.name}
                                            </h4>
                                        </div>
            ...
            animate={{
                ...
                <DialogBody divider>
                    <div>
                        ...
                        <p className="text-black text-base font-inter leading-none py-4">
                            Add some products
                        </p>
                    </div>
                </DialogBody>
